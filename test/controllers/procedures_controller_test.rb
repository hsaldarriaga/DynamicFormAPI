...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { description: @procedure.description, group_id: @procedure.group_id, name: @procedure.name, procedure_id: @procedure.procedure_id }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { description: @procedure.description, group_id: @procedure.group_id, name: @procedure.name, procedure_id: @procedure.procedure_id }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
